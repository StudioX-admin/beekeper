<template>
  <v-app>
    <v-app-bar app color="primary" dark>
      ...
      <v-toolbar-title>Beekeper 관리자</v-toolbar-title>
      <v-spacer></v-spacer>
    ...
    <v-navigation-drawer v-model="drawer" app>
      <v-list>
        ...
        <v-list-item to="/admin/reservations" prepend-icon="mdi-calendar">
          <v-list-item-title>예약 관리</v-list-item-title>
        </v-list-item>
        
        <v-list-item to="/admin/contracts" prepend-icon="mdi-file-document">
        ...
        <v-list-group value="support">
          ...
          <v-list-item to="/admin/notices" prepend-icon="mdi-bullhorn">
            <v-list-item-title>공지사항 관리</v-list-item-title>
          </v-list-item>
          
          <v-list-item to="/admin/inquiries" prepend-icon="mdi-help-circle">
            <v-list-item-title>1:1 문의 관리</v-list-item-title>
          </v-list-item>
        </v-list-group>
        
        <v-list-item to="/admin/settings" prepend-icon="mdi-cog">
