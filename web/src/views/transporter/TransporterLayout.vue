<template>
  <v-app>
    ...
    <v-navigation-drawer v-model="drawer" app>
      <v-list>
        <v-list-item to="/transporter" prepend-icon="mdi-view-dashboard">
          <v-list-item-title>대시보드</v-list-item-title>
        </v-list-item>
        
        <v-list-item to="/transporter/reservations" prepend-icon="mdi-calendar">
          <v-list-item-title>예약 관리</v-list-item-title>
        </v-list-item>
        
        <v-list-item to="/transporter/contracts" prepend-icon="mdi-file-document">
        ...
        <v-list-group value="resource">
          ...
          <v-list-item to="/transporter/vehicles" prepend-icon="mdi-truck">
            <v-list-item-title>차량 관리</v-list-item-title>
          </v-list-item>
          
          <v-list-item to="/transporter/users" prepend-icon="mdi-account-group">
        ...
        <v-list-item to="/transporter/profile" prepend-icon="mdi-office-building">
